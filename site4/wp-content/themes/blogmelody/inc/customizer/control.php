...
class BlogMelody_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogmelody-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class BlogMelody_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class BlogMelody_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class BlogMelody_Note_Control extends WP_Customize_Control {
