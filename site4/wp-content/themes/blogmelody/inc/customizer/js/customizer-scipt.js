...
( function( $, api ) {
    ...
    api.controlConstructor['blogmelody-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['blogmelody-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    $('#businessbiz-img-container li label img').click(function(){      
        $('#businessbiz-img-container li').each(function(){
            $(this).find('img').removeClass ('businessbiz-radio-img-selected') ;
        });
        $(this).addClass ('businessbiz-radio-img-selected') ;
    }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', businessbiz_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', businessbiz_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', businessbiz_customize_multi_remove_field )
    ...
    function businessbiz_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            businessbiz_customize_multi_write( $control );
    }

    function businessbiz_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        businessbiz_customize_multi_write( $control );
    }

    function businessbiz_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function businessbiz_customize_multi_write( $element) {
 ...
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #blogmelody-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #blogmelody-img-container li').each(function(){
            $(this).find('img').removeClass ('blogmelody-radio-img-selected') ;
        });
        $(this).addClass ('blogmelody-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #blogmelody-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #blogmelody-img-container li').each(function(){
            $(this).find('img').removeClass ('blogmelody-radio-img-selected') ;
        });
        $(this).addClass ('blogmelody-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #blogmelody-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #blogmelody-img-container li').each(function(){
            $(this).find('img').removeClass ('blogmelody-radio-img-selected') ;
        });
        $(this).addClass ('blogmelody-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #blogmelody-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #blogmelody-img-container li').each(function(){
            $(this).find('img').removeClass ('blogmelody-radio-img-selected') ;
        });
        $(this).addClass ('blogmelody-radio-img-selected') ;
    });                 
