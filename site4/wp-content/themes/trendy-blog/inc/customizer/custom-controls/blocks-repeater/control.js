jQuery(document).ready(function($) {
    ...
    function repeater_value_refresh( _this ) {
        var controlValue = [], container =  ( _this.hasClass( "blocks-repeater-control-wrap" ) ) ? _this : _this.parents( ".blocks-repeater-control-wrap" )
        container.find( " > .trendy-blog-block" ).each(function() {
    ...
    $( ".blocks-repeater-control-wrap" ).on( "change keyup", ".trendy-blog-block .block-repeater-control-field", function() {
        var _this = $(this)
    ...
    $( ".blocks-repeater-control-wrap" ).on( "click", ".trendy-blog-block .close-block", function() {
        var _this = $(this)
        _this.parents(".trendy-blog-block").find( ".block-content-wrap" ).slideUp( "normal", function() {
            _this.parents(".trendy-blog-block").toggleClass("open").find( ".block-header-icon i" ).toggleClass( "fa-chevron-up fa-chevron-down" );
        });
    })

    // remove block
    $( ".blocks-repeater-control-wrap" ).on( "click", ".trendy-blog-block .remove-block", function() {
        var _this = $(this), blockelement = _this.parents(".trendy-blog-block"), par = blockelement.siblings( ".add-new-block" )
        blockelement.find( ".block-content-wrap" ).slideUp( "normal", function() {
            $(this).parent().remove();
            repeater_value_refresh( par )
        });
        _this.parents(".trendy-blog-block").find( ".block-header-icon i" ).toggleClass( "fa-chevron-up fa-chevron-down" );
    })
    ...
    $(".blocks-repeater-control-wrap").sortable({
        ...
        items: "> .trendy-blog-block",
        update: function (event, ui) {
            repeater_value_refresh( $(this) );
            $(this).find( " > .trendy-blog-block .remove-block" ).show()
            $(this).find( ".trendy-blog-block:first .remove-block" ).hide()
        }
    });
})