...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || color !== '' || checkbox !== '' ) {
                var repeater_value_array = {};
                repeater_value_array.id = id;
                if( typeof icon_value !== "undefined" ) {
                    repeater_value_array.icon_value =  ( choice === 'customizer_repeater_none' ) ? '' : icon_value 
                }
                if( typeof color !== "undefined" ) {
                    repeater_value_array.color = color 
                }
                if( typeof color2 !== "undefined" ) {
                    repeater_value_array.color2 = color2 
                }
                if( typeof text !== "undefined" ) {
                    repeater_value_array.text = escapeHtml(text) 
                }
                if( typeof link !== "undefined" ) {
                    repeater_value_array.link = link
                }
                if( typeof text2 !== "undefined" ) {
                    repeater_value_array.text2 = escapeHtml(text2)
                }
                if( typeof link2 !== "undefined" ) {
                    repeater_value_array.link2 = link2
                }
                if( typeof image_url !== "undefined" ) {
                    repeater_value_array.image_url =  ( choice === 'customizer_repeater_none' ) ? '' : image_url 
                }
                if( typeof choice !== "undefined" ) {
                    repeater_value_array.choice = choice
                }
                if( typeof title !== "undefined" ) {
                    repeater_value_array.title = escapeHtml(title)
                }
                if( typeof subtitle !== "undefined" ) {
                    repeater_value_array.subtitle = escapeHtml(subtitle)
                }
                if( typeof social_repeater !== "undefined" ) {
                    repeater_value_array.social_repeater = escapeHtml(social_repeater)
                }
                if( typeof shortcode !== "undefined" ) {
                    repeater_value_array.shortcode = escapeHtml(shortcode)
                }
                if( typeof checkbox !== "undefined" ) {
                    repeater_value_array.checkbox = checkbox
                }
                values.push( repeater_value_array );
            }
