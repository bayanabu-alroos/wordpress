...
if ( ! function_exists( 'vivid_blog_sanitize_select' ) ) :
	/**
	 ...
	 */
	function vivid_blog_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'vivid_blog_sanitize_image' ) ) :
	/**
	 ...
	 */
	function vivid_blog_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'vivid_blog_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function vivid_blog_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'vivid_blog_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Vivid Blog 1.0.0
	*/
	function vivid_blog_sanitize_page( $input ) {
...
if ( ! function_exists( 'vivid_blog_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Vivid Blog 1.0.0
	 ...
	 */
	function vivid_blog_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'vivid_blog_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Vivid Blog 1.0.0
	 */
	function vivid_blog_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'vivid_blog_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Vivid Blog 1.0.0
	 */
	function vivid_blog_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'vivid_blog_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function vivid_blog_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function vivid_blog_sanitize_switch_control( $input ) {
...
* @since Vivid Blog 1.0.0
*/
function vivid_blog_sanitize_links( $input ) {
