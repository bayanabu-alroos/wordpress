 ...
 */
class Vivid_Blog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__( '--None--', 'vivid-blog') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Vivid_Blog_Dropdown_Category_Control extends WP_Customize_Control {
...
class Vivid_Blog_Note_Control extends WP_Customize_Control {
...
class Vivid_Blog_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Vivid_Blog_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="vivid-blog-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Vivid_Blog_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Vivid_Blog_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="vivid-blog-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'vivid-blog' ); ?>" class="vivid-blog-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Vivid_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Vivid_Blog_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
