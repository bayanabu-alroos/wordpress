...
class Vivid_Blog_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'vivid_blog';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'vivid-blog' ), $i ),
...
// Initialize.
$vivid_blog_footer_widgets = new Vivid_Blog_Footer_Widgets();
