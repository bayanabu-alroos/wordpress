...
class Juju_Blog_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'juju_blog';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'juju-blog' ), $i ),
...
// Initialize.
$juju_blog_footer_widgets = new Juju_Blog_Footer_Widgets();
