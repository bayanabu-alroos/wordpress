 ...
 */
class Juju_Blog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Juju_Blog_Note_Control extends WP_Customize_Control {
...
class Juju_Blog_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Juju_Blog_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="juju-blog-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Juju_Blog_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Juju_Blog_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="juju-blog-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'juju-blog' ); ?>" class="juju-blog-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Juju_Blog_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Juju_Blog_Dropdown_Category_Control extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Juju_Blog_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Juju_Blog_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="juju-blog-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
