...
( function( $, api ) {
    ...
    api.controlConstructor['giddy-blog-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['giddy-blog-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#giddy-blog-img-container li label img').click(function(){       
    //     $('#giddy-blog-img-container li').each(function(){
    //         $(this).find('img').removeClass ('giddy-blog-radio-img-selected') ;
    //     });
    //     $(this).addClass ('giddy-blog-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', giddy_blog_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', giddy_blog_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', giddy_blog_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #giddy-blog-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #giddy-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('giddy-blog-radio-img-selected') ;
        });
        $(this).addClass ('giddy-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #giddy-blog-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #giddy-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('giddy-blog-radio-img-selected') ;
        });
        $(this).addClass ('giddy-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #giddy-blog-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #giddy-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('giddy-blog-radio-img-selected') ;
        });
        $(this).addClass ('giddy-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #giddy-blog-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #giddy-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('giddy-blog-radio-img-selected') ;
        });
        $(this).addClass ('giddy-blog-radio-img-selected') ;
    });    

    function giddy_blog_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            giddy_blog_customize_multi_write( $control );
    }

    function giddy_blog_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        giddy_blog_customize_multi_write( $control );
    }

    function giddy_blog_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function giddy_blog_customize_multi_write( $element) {
