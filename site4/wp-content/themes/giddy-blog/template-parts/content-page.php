...
?>
<?php 
$enable_video = giddy_blog_get_option( 'single_page_video_enable' );
$enable_image = giddy_blog_get_option( 'single_page_image_enable' );
$enable_header_image     = giddy_blog_get_option( 'single_page_header_image_enable' ); ?>
