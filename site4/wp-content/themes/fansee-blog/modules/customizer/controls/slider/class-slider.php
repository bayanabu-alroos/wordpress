...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Fansee_Blog_Customizer_Slider_Control extends WP_Customize_Control {

		public $type = 'fansee-blog-slider';
...
function fansee_blog_slider_control_register( $wp_customize ){
	$wp_customize->register_control_type( 'Fansee_Blog_Customizer_Slider_Control' );
}
add_action( 'customize_register', 'fansee_blog_slider_control_register' );