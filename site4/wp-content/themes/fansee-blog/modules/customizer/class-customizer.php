 ...
 */
if( !class_exists( 'Fansee_Blog_Customizer' ) ){
	class Fansee_Blog_Customizer{
			...
			foreach ( $this->fields as  $section ) {
				...
				if(! in_array( $section[ 'id' ], self::$default_sections ) ){
					...
					if( isset( $section[ 'type' ] ) && $section[ 'type' ] == 'link' ){
						$wp_customize->add_section( new Fansee_Blog_Customizer_Link_Control( $wp_customize, $section_id, $section_args ) );
					}else{
					...
					foreach( $section[ 'fields' ] as $field ){
						...
						switch( $control[ 'type' ] ){
							...
							case 'toggle':
								...
								$wp_customize->add_control( new Fansee_Blog_Toggle_Control( $wp_customize, $id, $control ) );
							break;

							case 'page-repeater':
								$control[ 'type' ] = self::get_id( $control[ 'type' ] );
								$wp_customize->add_control( new Fansee_Blog_Page_Repeater( $wp_customize, $id, $control ) );
							break;
							...
							case 'slider':
								...
								$wp_customize->add_control( new Fansee_Blog_Customizer_Slider_Control( $wp_customize, $id, $control ) );
							break;
							...
							case 'dropdown-categories':
								...
								$wp_customize->add_control(
									new Fansee_Blog_Customizer_Dropdown_Categories_Control( $wp_customize, $id, $control ) );
							break;
