...
if( !class_exists( 'Clean_Design_Blog_Theme_Info' ) ) :
    class Clean_Design_Blog_Theme_Info {
        ...
        function __construct() {
            ...
            add_action( 'wp_ajax_clean_design_blog_set_ajax_transient', array( $this, 'clean_design_blog_set_ajax_transient' ) );
        }
         ...
         * 
         */
        function clean_design_blog_set_ajax_transient() {
            set_transient( 'clean_design_blog_review_notice', '1' );
            $this->ajax_response['status'] = true;
            $this->ajax_response['message'] = esc_html__( 'Review notice hidden.', 'clean-design-blog' );
        ...
        function theme_info_scripts($hook) {
            ...
            if( ! get_transient( 'clean_design_blog_review_notice' ) ) {
                wp_enqueue_style( 'clean-design-blog-review-notice', get_template_directory_uri() . '/inc/admin/assets/review-notice.css', array(), esc_attr( $this->version ), 'all' );
                wp_enqueue_script( 'clean-design-blog-review-notice', get_template_directory_uri() . '/inc/admin/assets/review-notice.js', array( 'jquery' ), esc_attr( $this->version ), true );
                wp_localize_script( 'clean-design-blog-review-notice', 'cleanDesignBlogThemeInfoObject', array(
        ...
        function add_review_admin_notice() {
            ...
            if( get_transient( 'clean_design_blog_review_notice' ) === '1' ) {
                return;
            }
            ?>
            <div class="clean-design-blog-review-notice notice notice-success is-dismissible">
                <h2><?php esc_html_e( 'Clean Design Blog Review Notice', 'clean-design-blog' ); ?></h2>
                <div class="notice-content-wrap">
                    <div class="notice-content">
                        <span class="notice-highlight"><?php esc_html_e( "How was your experience using Clean Design Blog theme ? ", "clean-design-blog" ); ?></span>
                        <p><?php esc_html_e( "We are constantly striving to improve and we'd like to hear from you. Hope you spend your few seconds reviewing our product. We appreciate your time and feedback! Thank you!!", "clean-design-blog" ); ?> <span class="dashicons dashicons-smiley"></span></p>
                        <div class="notice-actions">
                            <a class="button review" data-redirect="<?php echo esc_url( '//wordpress.org/support/theme/clean-design-blog/reviews/?filter=5' ); ?>" target="_blank"><span class="dashicons dashicons-thumbs-up"></span><?php esc_html_e( 'Leave A Review', 'clean-design-blog' ); ?></a>
                            <a class="button dismiss"><span class="dashicons dashicons-dismiss"></span><?php esc_html_e( 'Dismiss Notice', 'clean-design-blog' ); ?></a>
                        </div>
                    </div>
                </div><!-- .notice-content-wrap -->
            </div>
