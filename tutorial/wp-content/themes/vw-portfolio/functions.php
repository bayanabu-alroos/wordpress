...
function vw_portfolio_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=vw_portfolio_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-portfolio' ) .'</a></span>';
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-portfolio-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-portfolio' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/wordpress-portfolio-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-portfolio' ) .'</a></span>';
	echo '</div>';
}
